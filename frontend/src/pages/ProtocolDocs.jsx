      ...
      <div className="space-y-16">
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/50 border border-[#45A29E]/30 rounded-xl p-8 backdrop-blur-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h3 className="text-2xl font-bold text-[#66FCF1]">1. How It Works</h3>
          </div>
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/50 border border-[#45A29E]/30 rounded-xl p-8 backdrop-blur-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h3 className="text-2xl font-bold text-[#66FCF1]">2. Asset Lifecycle</h3>
          </div>
          <ol className="list-decimal list-inside text-[#C5C6C7] space-y-4 ml-2">
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/50 border border-[#45A29E]/30 rounded-xl p-8 backdrop-blur-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h3 className="text-2xl font-bold text-[#66FCF1]">3. Protocol Architecture</h3>
          </div>
          <p className="text-[#C5C6C7] leading-relaxed mb-4">
