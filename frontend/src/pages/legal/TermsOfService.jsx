...
const TermsOfService = () => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl md:text-4xl font-bold text-white mb-3 tracking-tight">Terms of Service</h1>
      ...
      <div className="space-y-6 md:space-y-8">
        <motion.section variants={itemVariants} className="bg-[#1e2024]/40 border border-[#45A29E]/20 rounded-xl p-5 md:p-8">
          <div className="flex items-center gap-4 mb-4 text-[#66FCF1]">
            ...
            <h3 className="text-lg md:text-xl font-bold">1. Non-Custodial Protocol</h3>
          </div>
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/40 border border-[#45A29E]/20 rounded-xl p-5 md:p-8">
          <div className="flex items-center gap-4 mb-4 text-[#66FCF1]">
            ...
            <h3 className="text-lg md:text-xl font-bold">2. User Responsibility</h3>
          </div>
          <p className="text-[#C5C6C7] leading-relaxed">
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/40 border border-[#45A29E]/20 rounded-xl p-5 md:p-8">
          <div className="flex items-center gap-4 mb-4 text-[#66FCF1]">
            ...
            <h3 className="text-lg md:text-xl font-bold">3. Risks and "As Is" Warranty</h3>
          </div>
          <p className="text-[#C5C6C7] leading-relaxed">
        ...
        <motion.section variants={itemVariants} className="bg-[#1e2024]/40 border border-[#45A29E]/20 rounded-xl p-5 md:p-8">
          <div className="flex items-center gap-4 mb-4 text-[#66FCF1]">
            ...
            <h3 className="text-lg md:text-xl font-bold">4. Compliance and SCAI Mainnet</h3>
          </div>
          <p className="text-[#C5C6C7] leading-relaxed">
